...
<section id="title">
    ...
    <img src="{{ asset('images/Laundry Stack.jpg') }}" alt="An Image of Fresh Clothes Stacked Upon Each Other">
</section>
...
<section id="variableStatistic">
    <img src="{{ asset('images/Pollution Landscape.jpg') }}" alt="An Image of a foggy woodland with a large chute of polluted smoke in the background.">
    <div id="infoBox">
        <h3>2025</h3>
...
<section id="variableStatistic">
    <img src="{{ asset('images/Clothes on Hangers.jpg') }}" alt="An Image of blazers hung by hangers with a soft, golden glow on the background.">
